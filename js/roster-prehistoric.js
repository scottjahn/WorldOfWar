...
(function (W) {
   ...
   * `sfx` names this mount's voice in js/sounds-prehistoric.js; a bite that does
   * not name one gets plain teeth. */
  function bite(def) {
    return Object.assign({ kind: 'melee', name: 'Bite', sfx: 'bite', speed: 0, spread: 0, targets: GROUND }, def);
  }
  ...
  W.RosterPrehistoric = {
    ...
    compsognathus: unit({
      ...
      weapons: [bite({ name: 'Nip', sfx: 'nip', dmg: 6, pen: 4, range: 26, cd: 0.55 })]
    }),
    ...
    gallimimus: unit({
      ...
      weapons: [bite({ name: 'Kick', sfx: 'nip', dmg: 13, pen: 9, range: 30, cd: 0.6 })]
    }),
    ...
    sanajeh: unit({
      ...
      weapons: [bite({ name: 'Coil', sfx: 'constrict', dmg: 24, pen: 20, range: 28, cd: 0.75 })]
    }),
    ...
    velociraptor: unit({
      ...
      weapons: [bite({ name: 'Sickle Claw', sfx: 'claw', dmg: 26, pen: 22, range: 30, cd: 0.5, targets: ALL })]
    }),
    ...
    parasaurolophus: unit({
      ...
      weapons: [bite({ name: 'Trample', sfx: 'stomp', dmg: 30, pen: 24, range: 32, cd: 0.85 })]
    }),
    ...
    dilophosaurus: unit({
      ...
      weapons: [
        { name: 'Venom Spit', sfx: 'spit', dmg: 24, pen: 28, range: 195, cd: 0.85, spread: 0.06, targets: ALL, color: '#a8e85a', tracerWidth: 2.2 },
        bite({ name: 'Bite', sfx: 'bite', dmg: 20, pen: 16, range: 30, cd: 0.7 })
      ]
    }),
    ...
    pachycephalosaurus: unit({
      ...
      weapons: [bite({ name: 'Head Ram', sfx: 'ram', dmg: 56, pen: 42, range: 32, cd: 1.0 })]
    }),
    ...
    smilodon: unit({
      ...
      weapons: [bite({ name: 'Sabre Bite', sfx: 'bite', dmg: 66, pen: 58, range: 34, cd: 0.65, targets: ALL })]
    }),
    ...
    stegosaurus: unit({
      ...
      weapons: [bite({ name: 'Thagomizer', sfx: 'club', dmg: 96, pen: 64, range: 40, cd: 1.2, splash: 26 })]
    }),
    ...
    allosaurus: unit({
      ...
      weapons: [bite({ name: 'Bite', sfx: 'jaws', dmg: 80, pen: 66, range: 36, cd: 0.7, targets: ALL })]
    }),
    ...
    ankylosaurus: unit({
      ...
      weapons: [bite({ name: 'Tail Club', sfx: 'club', dmg: 110, pen: 74, range: 40, cd: 1.4, splash: 30 })]
    }),
    ...
    titanoboa: unit({
      ...
      weapons: [bite({ name: 'Constriction', sfx: 'constrict', dmg: 175, pen: 84, range: 42, cd: 1.7 })]
    }),
    ...
    triceratops: unit({
      ...
      weapons: [bite({ name: 'Horn Charge', sfx: 'ram', dmg: 122, pen: 90, range: 40, cd: 1.1, splash: 18 })]
    }),
    ...
    mammoth: unit({
      ...
      weapons: [bite({ name: 'Tusks', sfx: 'ram', dmg: 130, pen: 92, range: 44, cd: 1.25, splash: 24 })]
    }),
    ...
    spinosaurus: unit({
      ...
      weapons: [
        bite({ name: 'Crocodile Jaws', sfx: 'jaws', dmg: 152, pen: 110, range: 46, cd: 1.0 }),
        bite({ name: 'Hooked Claws', sfx: 'claw', dmg: 74, pen: 62, range: 44, cd: 1.3, splash: 22 })
      ]
    }),
    ...
    trex: unit({
      ...
      weapons: [bite({ name: 'Killing Bite', sfx: 'roar', dmg: 250, pen: 150, range: 46, cd: 1.3, targets: ALL })]
    }),
    ...
    brachiosaurus: unit({
      ...
      weapons: [
        bite({ name: 'Stomp', sfx: 'stomp', dmg: 165, pen: 82, range: 48, cd: 1.8, splash: 38 }),
        bite({ name: 'Neck Sweep', sfx: 'club', dmg: 70, pen: 60, range: 52, cd: 1.4, targets: AIR })
      ]
    }),
    ...
    meganeura: unit({
      ...
      weapons: [bite({ name: 'Mandibles', sfx: 'nip', dmg: 6, pen: 5, range: 26, cd: 0.5, targets: ALL })]
    }),
    ...
    microraptor: unit({
      ...
      weapons: [bite({ name: 'Claws', sfx: 'claw', dmg: 15, pen: 11, range: 28, cd: 0.55, targets: ALL })]
    }),
    ...
    rhamphorhynchus: unit({
      ...
      weapons: [bite({ name: 'Needle Teeth', sfx: 'screech', dmg: 30, pen: 24, range: 30, cd: 0.55, targets: ALL })]
    }),
    ...
    pteranodon: unit({
      ...
      weapons: [bite({ name: 'Beak Strike', sfx: 'screech', dmg: 60, pen: 46, range: 34, cd: 0.7, targets: ALL })]
    }),
    ...
    quetzalcoatlus: unit({
      ...
      weapons: [bite({ name: 'Spear Beak', sfx: 'screech', dmg: 112, pen: 86, range: 40, cd: 0.85, targets: ALL })]
    }),
    ...
    ammonite: unit({
      ...
      weapons: [bite({ name: 'Tentacles', sfx: 'wetSnap', dmg: 11, pen: 8, range: 28, cd: 0.9, targets: SEA })]
    }),
    ...
    ichthyosaur: unit({
      ...
      weapons: [bite({ name: 'Snap', sfx: 'wetSnap', dmg: 34, pen: 30, range: 30, cd: 0.55, targets: SEA })]
    }),
    ...
    archelon: unit({
      ...
      weapons: [bite({ name: 'Beak', sfx: 'wetSnap', dmg: 42, pen: 32, range: 32, cd: 1.2, targets: SEA })]
    }),
    ...
    palaeophis: unit({
      ...
      weapons: [bite({ name: 'Strike', sfx: 'wetSnap', dmg: 74, pen: 76, range: 36, cd: 0.7 })]
    }),
    ...
    dunkleosteus: unit({
      ...
      weapons: [bite({ name: 'Shearing Jaws', sfx: 'chomp', dmg: 106, pen: 90, range: 34, cd: 1.0, targets: SEA })]
    }),
    ...
    elasmosaurus: unit({
      ...
      weapons: [bite({ name: 'Long Neck', sfx: 'wetSnap', dmg: 78, pen: 58, range: 64, cd: 0.75, targets: ALL })]
    }),
    ...
    mosasaurus: unit({
      ...
      weapons: [bite({ name: 'Lunge', sfx: 'chomp', dmg: 178, pen: 122, range: 46, cd: 1.1, targets: ALL })]
    }),
    ...
    megalodon: unit({
      ...
      weapons: [bite({ name: 'Devour', sfx: 'chomp', dmg: 305, pen: 165, range: 50, cd: 1.35 })]
    })
  };
})(window);
